...
By the end of the project, the device was capable of drawing on the screen and displaying a vareity of colors. It had also previously demonstrated its ability to draw, and control if the brush was up or down, using the inputs of the MCU controller. This was captured in a photograph (@fig-workingModel)
