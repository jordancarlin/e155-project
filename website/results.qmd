...
Our Final project was made using several bread boards, as well as several printed components that give it a finished look. These parts were a breakout board with several color buttons, as well as a casing for a joystick, switch, and potentiometer system.
